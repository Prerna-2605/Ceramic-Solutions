        ...
        <div className='mb-[140px] '>
            <div className='max-w-[1140px] mx-auto px-3'>
                <motion.div
                    ...
                    viewport={{ once: true }} className='max-w-[1140px] mx-auto w-full relative bg-center bg-cover bg-no-repeat rounded-3xl z-0 after:content-[""] after:absolute after:rounded-3xl after:top-0 after:left-0 after:z-1 after:w-full after:h-full after:bg-[#FF0000BF] py-[64px] flex flex-col items-center ' style={{ backgroundImage: `url(${bgimg})` }}>
